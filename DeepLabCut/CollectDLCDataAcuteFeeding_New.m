...
%% Run a single file
FileFolder='C:\Users\netas\Documents\Lammel lab\Obesity paper\EXPERIMENTS\DeepLabCut\Videos to analyse';
FileName='8-9DLC_resnet50_NewOptogeneticsJul17shuffle1_100000.csv' ; 
DisplayPlot=true;
Threshold=20;
[TrialArray] = AcutFeedingVideoAnalyseNew(FileFolder,FileName,DisplayPlot,Threshold) ;
%% Run batch files
